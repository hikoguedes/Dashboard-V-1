    ...
    .card span {
        ...
        if df_filtrado.empty:
            ...
            with col1:
                    ...
                    def formatar_br(total_valor_vendido_sem_cancelado):
                            return f"R$ {total_valor_vendido_sem_cancelado:,.2f}".replace(",", "X").replace(".", ",").replace("X", ".")
                    # Função de formatação
...
#<span style="font-size: 8px;">R$ {formatar_br(ultimo_valor)}</span>
            ...
            with col2:
                st.markdown(
                    f"""
                        <div class="card" style="background-color:#12172b">
                            <span style="font-size: 20px; color: white; font-size: 14px; font-weight: bold;">VGV Total Bruto</span>
                            <span style="font-size: 20px; color: white;">{formatar_br(vgv_total_bruto_por_pendente_assinatura)}</span>
                            <span style="font-size: 20px; color: white;">Pendente Assinatura: {quant_nao_assinado}</span>
                        </div>
                        """,
                    unsafe_allow_html=True
                )
                ...
                st.markdown(
                    f"""
                        <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white;">{quant_a_vista}</span>
                            <span style="font-size: 20px; color: white;">{percent_a_vista}%</span>
                        </div>
                        """,
                    unsafe_allow_html=True
                )
                ...
                st.markdown(
                    f"""
                        <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white; font-size: 20px;">R$ {formatar_br(valor_final)}</span>
            ...
            with col2:
                st.markdown(
                    f"""
                        <div class="card" style="background-color:#12172b">
                            <span style="font-size: 20px; color: white; font-size: 14px; font-weight: bold;">VGV Total Liquido</span>
                ...
                st.markdown(
                    f"""
                        <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white;">{formatar_br(ticket_medio_filtrado)}</span>
                        </div>
                        """,
                    unsafe_allow_html=True
                )
                ...
                st.markdown(
                    f"""
                        <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white;">{quant_curta}</span>
                            <span style="font-size: 20px; color: white;">{percent_curta}%</span>
                        </div>
                        """,
                    unsafe_allow_html=True
                )
        ...
        if df_filtrado.empty:
            ...
            with col26:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">{percent_desconto_financeiro}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
            ...
            with col27:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white;">{quant_integral}</span>
                            <span style="font-size: 20px; color: white;">{percent_integral}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
            ...
            with col28:
                st.markdown(
                    f"""
                    <div class="card" style="background-color:#12172b">
                        <span style="font-size: 20px; color: white; font-size: 14px; font-weight: bold;">DISTRATOS</span>
                        <span style="font-size: 20px; color: white;">{formatar_br(distrato_valor)}</span>
                        <span style="font-size: 20px; color: white;">{percentual_distrato_upgrade_sobre_cancelado}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
                ...
                with col29:
                    ...
                    <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white;">{quant_longa}</span>
                            <span style="font-size: 20px; color: white;">{percent_longa}%</span>
                    </div>
                    """,
                        unsafe_allow_html=True
                    )
            ...
            with col26:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">R$ {formatar_br(total_desconto_viabilidade)}</span>
                        <span style="font-size: 20px; color: white;">{percent_desconto_viabilidade}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
            ...
            with col27:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">{quant_4_semanas}</span>
                        <span style="font-size: 20px; color: white;">{percent_4_semanas}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
            ...
            with col28:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">{formatar_br(distrato_valor_up_grade)}</span>
                        <span style="font-size: 20px; color: white;">{percentual_distrato_up_grade}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
                ...
                with col29:
                    ...
                    <div class="card" style="background-color:#12172b">
                            ...
                            <span style="font-size: 20px; color: white;">{quant_longuissima}</span>
                            <span style="font-size: 20px; color: white;">{percent_longuissima}%</span>
                    </div>
                    """,
                        unsafe_allow_html=True
                    )
            ...
            with col27:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">{quant_6_semanas}</span>
                        <span style="font-size: 20px; color: white;">{percent_6_semanas}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
            ...
            with col28:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">{soma_percentual_entrada:.2f}%</span>
            ...
            with col27:
                st.markdown(
                    ...
                    <div class="card" style="background-color:#12172b">
                        ...
                        <span style="font-size: 20px; color: white;">{quant_13_semanas}</span>
                        <span style="font-size: 20px; color: white;">{percent_13_semanas}%</span>
                    </div>
                    """,
                    unsafe_allow_html=True
                )
